...
### Limitation
ZAP's built-in fuzzer was functional but slow when working through a search space of 67,600 combinations. Given that the correct answer (64jm) was well into the search space alphabetically, the process was taking too long to complete in a reasonable timeframe.
